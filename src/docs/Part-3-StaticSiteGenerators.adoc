...
Was machen wir jetzt mit unsere HTML Sanity Check?
Er testet die fertige Seite und kann somit schlecht direkt von jBake in die Seite eingebettet werden.

Für ejde Seite haben wir die Wahl der Tempalte-Engine in dem wir die Dateiendung wählen.
Für den Test-Report gehen wir auch hier wieder auf HTML und embedden den Report, der erst nach der eigentlichen Site generiert wird, per iFrame.
