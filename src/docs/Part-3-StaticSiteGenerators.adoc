...
Das Asciidoctor-Projekt stellt https://github.com/asciidoctor/jekyll-asciidocx[ein Plugin] zur Verfügung mit dem Jekyll nach einer kleinen Konfiguration auch sehr gut AsciiDoc unterstützt.
